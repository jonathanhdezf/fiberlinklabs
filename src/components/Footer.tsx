                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm font-medium text-slate-600 dark:text-slate-400">
                            <li><a href="#" className="hover:text-primary transition-colors dark:text-white">Desarrollo Web</a></li>
                            <li><a href="#" className="hover:text-primary transition-colors dark:text-white">Sistemas POS</a></li>
                            <li><a href="#" className="hover:text-primary transition-colors dark:text-white">Automatización</a></li>
                            <li><a href="#" className="hover:text-primary transition-colors dark:text-white">Infraestructura Cloud</a></li>
                        </ul>
                    </div>
